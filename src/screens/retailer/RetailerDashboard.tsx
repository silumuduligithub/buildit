    ...
    <View style={styles.root}>
      ...
      >
        <View style={styles.topLeft}>
          <TouchableOpacity
            ...
            onPress={() => Alert.alert('Menu', 'Store settings, analytics & profile')}
          >
        ...
        <TouchableOpacity
          ...
          onPress={() => Alert.alert('Notifications', '8 unread alerts for inventory & orders')}
        >
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.greetingRow}>
          <View style={{ flex: 1 }}>
            <Text style={styles.greetingTitle}>Hello, Retailer! 👋</Text>
            <Text style={styles.greetingSubtitle}>Here's what's happening with BuildKart today.</Text>
          </View>

          <TouchableOpacity
            style={styles.datePickerBtn}
            onPress={() => Alert.alert('Select Date', 'Filter metrics by custom date')}
          >
        ...
        <View style={styles.chartCard}>
          ...
          {/* Interactive Line Graph Graphic */}
        ...
        <View style={styles.donutCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() => Alert.alert('Report', 'Opening full order fulfillment report...')}
          >
        ...
        <View style={styles.ordersSectionCard}>
          <View style={styles.sectionHeaderRow}>
            ...
            <TouchableOpacity onPress={() => Alert.alert('All Orders', 'Viewing all 12,842 orders')}>
          ...
          <View style={styles.recentOrdersList}>
            {RECENT_ORDERS.map((order) => (
              <TouchableOpacity
                ...
                onPress={() => Alert.alert(`Order Details: ${order.id}`, `${order.item}\nAmount: ${order.amount}\nCustomer: ${order.customer}`)}
                activeOpacity={0.8}
              >
        ...
        {/* ── 8. Bottom Grids (Top Selling Categories & Alerts) ── */}
        <View style={styles.bottomGridsRow}>
          {/* Top Selling Categories */}
          <View style={styles.halfCard}>
            <View style={styles.sectionHeaderRow}>
              <Text style={styles.halfCardTitle}>Top Selling Categories</Text>
              <TouchableOpacity onPress={() => Alert.alert('Categories', 'Full category GMV breakdown')}>
          ...
          <View style={styles.halfCard}>
            <View style={styles.sectionHeaderRow}>
              ...
              <TouchableOpacity onPress={() => Alert.alert('Alerts', 'Viewing all 14 inventory alerts')}>
                <Text style={styles.viewAllLinkSmall}>View all</Text>
              </TouchableOpacity>
            </View>
            ...
            <TouchableOpacity
              ...
              onPress={() => Alert.alert('Low Stock Alert', '134 items below reorder threshold (UltraTech 50kg, Ramco Super, Tata 12mm)')}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() => Alert.alert('New Registrations', '12 contractors requesting credit line accounts')}
            >
      ...
      <View style={styles.bottomTabDock}>
        {[
          ...
          return (
            <TouchableOpacity
              key={tab.id}
              style={styles.dockTabItem}
              onPress={() => setActiveTab(tab.id)}
            >
              <Text style={[styles.dockIcon, isSelected ? styles.dockIconActive : styles.dockIconInactive]}>
                {tab.icon}
              </Text>
              <Text style={[styles.dockLabel, isSelected ? styles.dockLabelActive : styles.dockLabelInactive]}>
                {tab.label}
              </Text>
              {isSelected && <View style={styles.dockActiveDot} />}
            </TouchableOpacity>
          );
        })}
      </View>
